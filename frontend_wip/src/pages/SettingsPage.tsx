...
import { Layout, Typography, Card, Button, Upload, List, Space, Input, message, Tag, Alert, Empty, Form, Divider, Checkbox, Select, Slider, InputNumber, Switch } from 'antd';
import { DeleteOutlined, CheckCircleOutlined, CloseCircleOutlined, SaveOutlined, PlusOutlined } from '@ant-design/icons';

import axios from 'axios';

import { useIsMobile, API_BASE, ToolPolicyResponse, api } from '../shared';
