...
import { Layout, Typography, Card, Button, Upload, List, Space, Input, message, Tag, Progress, Badge, Drawer, Alert, Empty, Tooltip, Divider, Modal, Table, Select } from 'antd';
import { DeleteOutlined, ClockCircleOutlined, CheckCircleOutlined, SafetyCertificateOutlined, FileSearchOutlined, EyeOutlined, SaveOutlined, DownloadOutlined, ReloadOutlined, RollbackOutlined, ExclamationCircleOutlined, ToolOutlined, DeploymentUnitOutlined } from '@ant-design/icons';

import { Link } from 'react-router-dom';

import dayjs from 'dayjs';

import { useIsMobile, ReadinessStatus, SystemHealthReport, BackupArchiveSummary, OpsEvent, KnowledgeGraphQualityGate, LifecycleCleanupResult, ToolAuditEvent, statusTagColor, statusBadge, statusLabel, opsEventLabel, opsEventTypeOptions, opsEventStatusOptions, opsEventActorLabel, toolAuditStatusOptions, toolAuditStatusLabel, toolAuditStatusColor, formatBytes, formatDuration, AuthContext, api } from '../shared';
